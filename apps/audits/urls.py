...
urlpatterns = [
    ...
    path('<uuid:pk>/clone/', views.AuditClone.as_view(), name='clone'),
    ...
    path('answer/<uuid:pk>/clone/', views.AnswerClone.as_view(), name='answer-clone'),
    ...
    path('question/<uuid:pk>/clone/', views.QuestionClone.as_view(), name='question-clone'),
    ...
    path('template/<uuid:pk>/clone/', views.TemplateClone.as_view(), name='template-clone'),
]